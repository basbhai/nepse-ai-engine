...
from agents.wait_agent import agent_tools
from agents.wait_agent.condition_parser import get_parsed_condition
from agents.wait_agent.wait_evaluator   import evaluate_wait
...
def _get_open_waits_extended() -> dict:
    ...
    from agents.wait_agent.agent_tools import _safe_int
...
def run_wait_pipeline() -> dict:
    ...
    try:
        ...
        if get_setting("AGENT_USE_PIPELINE", "false").lower() != "true":
            ...
            from agents.wait_agent.agent import run_wait_monitor
