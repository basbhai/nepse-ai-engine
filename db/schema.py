...
TABLE_DDL: dict[str, str] = {
    ...
    CREATE TABLE IF NOT EXISTS "market_breadth" (
        ...
        sensitive_index TEXT,
        sensitive_change_pct TEXT,
        total_trades TEXT,
        market_cash_in TEXT,
        timestamp TEXT,
        inserted_at TIMESTAMPTZ DEFAULT NOW(),
    ...
    CREATE TABLE IF NOT EXISTS "nrb_monthly" (
        ...
        crr_percentage TEXT,
        slr_percentage TEXT,
        lending_rate_pct TEXT,
        deposit_rate_pct TEXT,
        interbank_rate_pct TEXT,
        tbill_91d_rate_pct TEXT,
        cpi_inflation TEXT,
        credit_growth_rate TEXT,
        private_sector_credit_growth_yoy_pct TEXT,
        ...
        remittance_total_billion_npr TEXT,
        fx_reserve_months TEXT,
        usd_npr_rate TEXT,
        bop_overall_balance_usd_m TEXT,
        bop_current_account_usd_m TEXT,
        bop_capital_account_usd_m TEXT,
        bop_trade_deficit_usd_m TEXT,
        bop_status TEXT,
        bop_trend TEXT,
        bop_impact_on_nepse TEXT,
        nepse_index_value TEXT,
        nepse_index TEXT,
    ...
    CREATE TABLE IF NOT EXISTS "trade_journal" (
        ...
        loss_cause TEXT,
        lesson_ids TEXT,
        momentum_status_entry TEXT,
        rsi_slope_3d_entry TEXT,
        macd_hist_slope_entry TEXT,
        bb_pct_b_slope_entry TEXT,
        bounce_failed_entry TEXT,
        reversal_days_entry TEXT,
        vwap_dev_entry TEXT,
        bid_ask_ratio_entry TEXT,
        dpr_proximity_entry TEXT,
        inserted_at TIMESTAMPTZ DEFAULT NOW()
    );
    ...
    CREATE TABLE IF NOT EXISTS "paper_trade_log" (
        ...
        created_at TEXT,
        test_mode TEXT DEFAULT 'false',
        close_type TEXT DEFAULT 'MANUAL',
        inserted_at TIMESTAMPTZ DEFAULT NOW()
    );
    ...
    CREATE INDEX IF NOT EXISTS ix_news_effect_patterns_active
        ON "news_effect_patterns" (active);
    """,
    ...
    CREATE TABLE IF NOT EXISTS "pattern_validation_log" (
        ...
        lag_start TEXT,
        lag_end TEXT,
        magnitude_applied TEXT,
        market_regime TEXT DEFAULT 'UNKNOWN',
        nepal_crisis_score_at_detection TEXT DEFAULT '0',
        predicted_date_start TEXT,
        predicted_date_end TEXT,
    ...
    CREATE INDEX IF NOT EXISTS ix_pattern_validation_log_event_date
        ON "pattern_validation_log" (event_date);
    ...
    "wait_parse_log": """
    CREATE TABLE IF NOT EXISTS "wait_parse_log" (
        id SERIAL PRIMARY KEY,
        market_log_id TEXT NOT NULL,
    ...
    CREATE INDEX IF NOT EXISTS ix_wait_parse_log_market_log_id
...
TABLE_COLUMNS: dict[str, list[str]] = {
    ...
    "nepal_pulse": ["date", "time", "policy_rate", "policy_rate_change", "nrb_event", "sebon_event", "circuit_breaker", "ipo_fpo_active", "ipo_fpo_detail", "govt_stability", "political_event", "budget_season", "budget_event", "remittance_yoy_pct", "inflation_pct", "forex_reserve_months", "bandh_today", "bandh_detail", "load_shedding_hrs", "nepal_score", "nepal_status", "key_event", "source", "timestamp", "headlines_politics", "headlines_economy", "headlines_stock"],
    "nrb_monthly": ["period", "fiscal_year", "month_number", "is_annual", "policy_rate", "bank_rate", "crr_percentage", "slr_percentage", "lending_rate_pct", "deposit_rate_pct", "interbank_rate_pct", "tbill_91d_rate_pct", "cpi_inflation", "credit_growth_rate", "private_sector_credit_growth_yoy_pct", "m2_growth_yoy_pct", "deposit_growth_yoy_pct", "npl_ratio_pct", "liquidity_injected_billion", "liquidity_status", "remittance_yoy_change_pct", "remittance_total_billion_npr", "fx_reserve_months", "usd_npr_rate", "bop_overall_balance_usd_m", "bop_current_account_usd_m", "bop_capital_account_usd_m", "bop_trade_deficit_usd_m", "bop_status", "bop_trend", "bop_impact_on_nepse", "nepse_index_value", "nepse_index", "market_cap_billion_npr", "overall_sentiment", "forward_guidance", "key_risks"],
    ...
    "paper_portfolio": ["telegram_id", "symbol", "status", "total_shares", "wacc", "total_cost", "first_buy_date", "last_buy_date", "buy_count", "exit_date", "exit_price", "exit_shares", "gross_pnl", "sell_fees", "cgt_paid", "net_pnl", "result", "created_at", "updated_at", "test_mode", "audited", "peak_price", "trail_active"],
    "paper_trade_log": ["telegram_id", "symbol", "action", "shares", "price", "gross_amount", "brokerage", "sebon", "dp_fee", "cgt", "total_fees", "net_amount", "capital_before", "capital_after", "wacc_before", "wacc_after", "note", "created_at", "test_mode", "close_type"],
